          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
              ...
              <div className="grid gap-4">
                <div>
                  <Image
                    ...
                    src={server?.message.loteMedicine[0].images[0]}
                    alt=""
                    width={100}
                    height={100}
                  />
                ...
                <div className="grid grid-cols-5 gap-4">
                  {server?.message.loteMedicine[0].images.map(
            ...
            <div className="mt-6 sm:mt-8 lg:mt-0">
              <h1 className="text-xl font-semibold text-white sm:text-2xl">
                {server?.message.loteMedicine[0].title as string}
              </h1>
              <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                <p className="text-2xl font-extrabold text-white sm:text-3xl">
                  R$ {server?.message.loteMedicine[0].value}
                </p>
              </div>

              <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                <a href={server?.message.loteMedicine[0].link} target="_blank">
                  <button
                    type="button"
              ...
              <p className="mb-6 text-white">
                {server?.message.loteMedicine[0].description.substring(0, 700)}
              </p>
            </div>
          </div>
        </div>
